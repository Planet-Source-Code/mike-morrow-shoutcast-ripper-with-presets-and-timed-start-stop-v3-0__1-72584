...
Begin VB.Form frmReboot 
   ...
   Begin VB.Label lblWhatsLeft 
      Alignment       =   2  'Center
      BackColor       =   &H00FFFFFF&
      Caption         =   "Your computer will reboot in 60 seconds.  Press Reboot to reboot now, Abort to abort rebooting."
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   14.25
         Charset         =   0
...
Private Sub Timer1_Timer()
  ...
  lblWhatsLeft = "Your computer will reboot in " & seconds & " seconds.  Press Reboot to reboot now, Abort to cancel rebooting."
